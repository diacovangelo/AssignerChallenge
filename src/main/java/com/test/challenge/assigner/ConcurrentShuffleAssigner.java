...
/**
 * Concurrent ShuffleAssigner
 * 
 * @author diacovangelo
 *
 */
public class ConcurrentShuffleAssigner implements Supplier<House>{
	...
	/**
	 * Assigning persons to rooms with a concurrent shuffle algorithm
	 * 
	 * @param rooms
	 * @param persons
	 * @param iterations
	 */
	public ConcurrentShuffleAssigner(List<Room> rooms, List<Person> persons, int iterations) {
		this.rooms = rooms;
